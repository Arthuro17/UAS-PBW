...
<body style="background: url(image/Bus.jpg); background-size: cover;" class="trans">
        ...
        <center>
            <div style="padding-top: 175px;">
                <a href="index.php" onclick="window.close();">
                    <img src="image/BusIn.png" class="img-responsive" style="width: 400px; height: 200px;">
                </a>
